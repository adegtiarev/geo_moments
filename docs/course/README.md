...
3. Для текущей главы открыть файл из [lessons](lessons).
4. Сверить код проекта с [ARCHITECTURE.md](ARCHITECTURE.md) и [DECISIONS.md](DECISIONS.md).
...
- Теория: только то, что нужно для выполнения задачи главы.
